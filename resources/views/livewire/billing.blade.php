<div>
    ...
    <x-modal title="รายการบิล" wire:model="showModal" maxWidth="2xl">
        ...
        <table class="table mt-3">
            ...
            <tbody>
                <tr>
                    <td>ค่าเช่าห้อง</td>
                    <td>
                        <input type="number" wire:model="amountRent" class="form-control text-right"
                ...
                <tr>
                    <td>
                        <div class="flex gap-2">
                            ...
                            <div class="w-1/3">
                                <input type="number" wire:model="waterUnit" class="form-control text-right"
                                    wire:change="computeSumAmount()">
                            </div>
                    ...
                    <td>
                        <input type="number" wire:model="amountWater" class="form-control text-right"
                            wire:change="computeSumAmount()">
                    </td>
                </tr>
                <tr>
                    <td>
                        <div class="flex gap-2">
                            ...
                            <div class="w-1/3">
                                <input type="number" wire:model="electricUnit" class="form-control text-right"
                                    wire:change="computeSumAmount()">
                            </div>
                            <div class="w-1/3">หน่วย</div>
                        </div>
                    ...
                    <td>
                        <input type="number" wire:model="amountElectric" class="form-control text-right"
                            wire:change="computeSumAmount()">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" wire:model="amountInternet" class="form-control text-right"
                            wire:change="computeSumAmount()">
                    </td>
                </tr>
                <tr>
                    <td>ค่าฟิตเนส</td>
                    <td>
                        <input type="number" class="form-control text-right" wire:model="amountFitness"
                            wire:change="computeSumAmount()" />
                    </td>
                </tr>
                <tr>
                    <td>ค่าซักรีด</td>
                    <td>
                        <input type="number" wire:model="amountWash" class="form-control text-right"
                            wire:change="computeSumAmount()">
                    </td>
                </tr>
                <tr>
                    <td>ค่าเก็บขยะ</td>
                    <td>
                        <input type="number" wire:model="amountBin" class="form-control text-right"
                            wire:change="computeSumAmount()">
                    </td>
                </tr>
                <tr>
                    <td>ค่าอื่น ๆ</td>
                    <td>
                        <input type="number" wire:model="amountEtc" class="form-control text-right"
                            wire:change="computeSumAmount()">
                    </td>
                </tr>
            </tbody>
        ...
        <div class="mt-3 text-center font-bold">
            รวมค่าใช้จ่าย : {{ number_format($sumAmount, 2) }} บาท
        </div>
    ...
    <x-modal-confirm title="ยืนยันการลบ" text="คุณต้องการลบรายการห้อง {{ $roomForDelete }} ใช่หรือไม่"
        showModalDelete="showModalDelete" maxWidth="sm" clickConfirm="deleteBilling"
    ...
    <x-modal title="รับเงิน" wire:model="showModalGetMoney">
        ...
        <div class="flex gap-2 justify-between">
            ...
            <div class="w-1/2 text-right">
                <a class="ms-3 bg-green-500 text-white px-3 py-2 rounded-lg hover:bg-green-600"
                    href="print-invoice/{{ $id }}" target="_blank">
                    <i class="fa fa-solid fa-print mr-2"></i>
                    พิมพ์ใบเสร็จรับเงิน
                </a>
            </div>
        </div>
        ...
        <div class="flex gap-2 mt-3">
            <div class="w-1/2">
                <div>ค่าปรับ</div>
                <input wire:blur="handleChangeAmountForGetMoney" type="number" class="form-control"
                    wire:model="moneyAdded" />
            </div>
            <div class="w-1/2">
                <div>ยอดรับเงิน</div>
        ...
        <div class="text-center mt-5">
            <button class="btn-success mr-2" wire:click="saveGetMoney()">
